...
INSERT INTO "new_TestOrder" ("createdAt", "doctorId", "id", "notes", "orderNumber", "patientId", "status", "title", "updatedAt") SELECT "createdAt", "doctorId", "id", "notes", "orderNumber", "patientId", "status", "title", "updatedAt" FROM "TestOrder";
